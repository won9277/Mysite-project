...
<link href="/Mysite-spring/assets/css/user.css" rel="stylesheet"
	type="text/css">
		...
		<div id="content">
			<div id="user">
				...
				<form id="join-form" name="joinForm" method="post"
					action="/Mysite-spring/member/join">
					<input type="hidden" name="a" value="join"> <label
						...
						src="/Mysite-spring/assets/images/check.png" id="email-checked"
						style="width: 18px; display: none" /> <input id="check-email"
